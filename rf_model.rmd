...
c("null", "null")), 
  ...
  pl <- p + theme(legend.position = "none") 
  pn <- p + theme_grey(legend_text_size)
...
library(dplyr)
journal_theme=theme(plot.title = element_text(hjust = 0.5),text = element_text(size=9), legend.position=c(0.1,0.5))
